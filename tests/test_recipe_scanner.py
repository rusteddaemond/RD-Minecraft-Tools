"""Unit tests for recipe scanner using new architecture."""
...
class TestRecipeScanner(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.processor = RecipeScannerProcessor(include_minecraft=False)
    ...
    def test_extract_results_single_string(self):
        ...
        results = self.processor._extract_results_from_json(content)
